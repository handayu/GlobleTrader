    ...
    public partial class TestSarForm : Form
    {
        ...
        public TestSarForm()
        {
            ...
            ChartInfo chartinfo = new ChartInfo()
            {
                ...
                RenkoBarBoxSize = 2,
                DataInterval = DATAInterval.MIN1,
        ...
        private void M_barMarker_NewRenkoBarComingEvent(Common.TestData.KlineOkex renkoBar, TestProxy.Interval Interval)
        {
            if (this.InvokeRequired)
            {
                this.BeginInvoke(new Action<Common.TestData.KlineOkex, TestProxy.Interval>(M_barMarker_NewRenkoBarComingEvent), renkoBar, Interval);
                return;
            }
