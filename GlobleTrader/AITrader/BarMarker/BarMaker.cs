...
namespace WindowsFormsApp1
{
    public class BarMarker
    {
        ...
        public delegate void BarComingHandle(TestData.KlineOkex Bar, TestProxy.Interval dataInterval);
        ...
        public BarMarker(ChartInfo info)
        {
            ...
            if (info.DataInterval == DATAInterval.UNKNOW || info.CandleType == CANDLETYPE.UNKNOW)
            {
                throw new Exception("the DataInterval or CandleType is is null");
            }
        ...
        private void AnsyTickerSubEvent(AIEventArgs args)
        {
            ...
            //            if (m_ChartInfo.DataInterval == Interval.Minute_1)
            //            {
            //                PublishKline1Bar(t, m_ChartInfo.DataInterval);
            //            }

            //            if (m_ChartInfo.DataInterval == DATAInterval.MIN5)
            //            {
            //                PublishKline5Bar(t, m_ChartInfo.DataInterval);
            //            }

            //            if (m_ChartInfo.DataInterval == DATAInterval.MIN15)
            //            {
            //                PublishKline15Bar(t, m_ChartInfo.DataInterval);
            //            }


            //            if (m_ChartInfo.DataInterval == DATAInterval.MIN30)
            //            {
            //                PublishKline30Bar(t, m_ChartInfo.DataInterval);
            //            }


            //            if (m_ChartInfo.DataInterval == DATAInterval.HOUR1)
            //            {
            //                PublishKline60Bar(t, m_ChartInfo.DataInterval);
            //            }
        ...
        private void PublishKline30Bar(swap.Ticker t, Interval Interval)
        {
            //记录第一笔进来的tick的时间戳，
            ...
            else
            {
                ...
                else
                {
                    ...
                    SafeRiseBarComingEvent(BarClone30Min, Interval);
        ...
        /// </summary>
        /// <param name="ticLiet"></param>
        private void PublishKline60Bar(swap.Ticker t, Interval Interval)
        {
            //记录第一笔进来的tick的时间戳，
            ...
            else
            {
                ...
                else
                {
                    ...
                    SafeRiseBarComingEvent(BarClone60Min,Interval);
        ...
        /// </summary>
        /// <param name="ticLiet"></param>
        private void PublishKline15Bar(swap.Ticker t, Interval Interval)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    SafeRiseBarComingEvent(BarClone15Min, Interval);
        ...
        /// </summary>
        /// <param name="ticLiet"></param>
        private void PublishKline5Bar(swap.Ticker t, Interval Interval)
        {
            //记录第一笔进来的tick的时间戳，更新分钟相同情况下的开高低收，直到分钟能被5整除发布，然后重新开始
            ...
            //        SafeRiseBarComingEvent(BarClone5Min, Interval);
        ...
        /// </summary>
        /// <param name="ticLiet"></param>
        private void PublishKline1Bar(swap.Ticker t, TestProxy.Interval Interval)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    SafeRiseBarComingEvent(BarClone1Min, Interval);
        ...
        private void PublishRenkoBar(swap.Ticker t)
        {
            ...
            //            //发布
            //            SafeRiseBarComingEvent(firstRenkoBar, m_ChartInfo.DataInterval);
            //        }
            ...
            //            //发布
            //            SafeRiseBarComingEvent(nowRenkoBar, m_ChartInfo.DataInterval);
            //        }
        ...
        private void SafeRiseBarComingEvent(TestData.KlineOkex Bar, TestProxy.Interval dataInterval)
        {
            if (BarComingEvent != null)
            {
                BarComingEvent(Bar, dataInterval);
            }
        }
    }
}
