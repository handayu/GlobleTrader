...
namespace AITrader
{
    public partial class ProxyTestForm : Form
    {
        ...
        private void Form_Load(object sender, EventArgs e)
        {
            ...
            ProxyManager.GetInstance().GetProxy(PROXYTHROUGH.Demo).OnLoginEvent += M_dP_OnFrontConnectedEvent;
            ProxyManager.GetInstance().GetProxy(PROXYTHROUGH.Demo).OnTickEvent += M_dP_OnRtnDataEvent;
        ...
        {
            string[] strList = { "" };
            ProxyManager.GetInstance().GetProxy(PROXYTHROUGH.Demo).SubScribe();
        }
