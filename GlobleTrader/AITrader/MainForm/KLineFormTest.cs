...
namespace WindowsFormsApp1
{
    public partial class KLineFormTest : DockContent
    {
        ...
        public KLineFormTest(swap.Ticker t, int formName)
        {
            ...
            ChartInfo chartInfo = new ChartInfo()
            {
                ...
                RenkoBarBoxSize = 0,
                DataInterval = DATAInterval.MIN5,
        ...
        private void M_barMaker_BarComingEvent(TestData.KlineOkex Bar, TestProxy.Interval Interval)
        {
            #region 在这里加入Bar--合成的实时的
            if (this.InvokeRequired)
            {
                this.BeginInvoke(new Action<TestData.KlineOkex, TestProxy.Interval>(M_barMaker_BarComingEvent), Bar, Interval);
                return;
            }
    ...
    this.splitContainer1.Panel1.Height + this.splitContainer1.Panel2.Height;
        ...
        private void toolStripButton_DayClick(object sender, EventArgs e)
        {
            ...
            //m_barMaker.CHARTINFO.DataInterval = DATAInterval.DAY1;
        ...
        private void toolStripButton_60MinClick(object sender, EventArgs e)
        {
            //直接在这里修改发布器的状态，发布器自动switch到MinBar的生成
            //m_barMaker.CHARTINFO.CandleType = CANDLETYPE.KLINEBAR;
            //m_barMaker.CHARTINFO.DataInterval = DATAInterval.HOUR1;
        ...
        private void toolStripButton_30MinClick(object sender, EventArgs e)
        {
            //直接在这里修改发布器的状态，发布器自动switch到MinBar的生成
            //m_barMaker.CHARTINFO.CandleType = CANDLETYPE.KLINEBAR;
            //m_barMaker.CHARTINFO.DataInterval = DATAInterval.MIN30;
        ...
        private void toolStripButton_15MinClick(object sender, EventArgs e)
        {
            //直接在这里修改发布器的状态，发布器自动switch到MinBar的生成
            //m_barMaker.CHARTINFO.CandleType = CANDLETYPE.KLINEBAR;
            //m_barMaker.CHARTINFO.DataInterval = DATAInterval.MIN15;
        ...
        private void toolStripButton_5MinClick(object sender, EventArgs e)
        {
            //直接在这里修改发布器的状态，发布器自动switch到MinBar的生成
            m_barMaker.CHARTINFO.CandleType = CANDLETYPE.KLINEBAR;
            m_barMaker.CHARTINFO.DataInterval = DATAInterval.MIN5;
        ...
        private void toolStripLabel_1Min_Click(object sender, EventArgs e)
        {
            //直接在这里修改发布器的状态，发布器自动switch到MinBar的生成
            //m_barMaker.CHARTINFO.CandleType = CANDLETYPE.KLINEBAR;
            //m_barMaker.CHARTINFO.DataInterval = DATAInterval.MIN1;
        ...
        {
            StrategySettingsForm s = new StrategySettingsForm(m_InitInsTicker, m_Interval);
            s.ShowDialog();
        ...
        private void ToolStripMenuItem_StrategyAutoActionClick(object sender, EventArgs e)
        {
            ...
            if (m_ISSwitch == false)
            {
                ...
                if (m_Strategy != null && ((IStrategy)m_Strategy).ISSTRATEGYGOING == false)
                {
                    ...
                    this.toolStripButton_StartStrategy.Image = global::AITrader.Properties.Resources.start;
