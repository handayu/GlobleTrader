...
namespace OKExSDK_V5
{
    public class TradeApi:SdkApi
    {
        ...
        public async Task<string> PlaceMultipleOrders(Dictionary<string, string> requestParams)
        {
        ...
        public async Task<string> CancelMultipleOrders(Dictionary<string, string> requestParams)
        {
        ...
        public async Task<string> AmendOrder(Dictionary<string, string> requestParams)
        {
        ...
        public async Task<string> AmendMultipleOrders(Dictionary<string, string> requestParams)
        {
        ...
        public async Task<string> PlaceAlgoOrder(Dictionary<string, string> requestParams)
        {
        ...
        public async Task<string> CancelAlgoOrder(Dictionary<string, string> requestParams)
        {
